            ...
            <div className="flex-1 max-w-xl mx-4 relative">
              <div className="relative">
                ...
                <Search
                  ...
                  } top-1/2 -translate-y-1/2 w-5 h-5 text-asper-gold`}
                />
                {searchQuery && (
                  <button
                    onClick={() => {
                    ...
                    } top-1/2 -translate-y-1/2 text-asper-charcoal/50 hover:text-asper-gold transition-colors duration-400`}
                  >
                    <X className="w-5 h-5" />
                  </button>
                )}
              ...
              >
                ...
                {wishlistItems.length > 0 && (
                  <span
                    ...
                    } h-4 w-4 rounded-full bg-asper-gold text-asper-merlot text-[10px] flex items-center justify-center font-body font-semibold`}
                  >
