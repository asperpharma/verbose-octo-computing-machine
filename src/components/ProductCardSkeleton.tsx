...
export const TestimonialCardSkeleton = ({ className }: ProductCardSkeletonProps) => {
  return (
    <div className={cn("animate-pulse bg-cream/5 border border-gold/10 rounded-lg p-8", className)}>
      {/* Quote Icon Skeleton */}
...
export const ImageSkeleton = ({ className }: { className?: string }) => {
  return (
    <div className={cn("animate-pulse bg-gradient-to-br from-cream via-taupe/20 to-cream relative overflow-hidden", className)}>
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent skeleton-shimmer" />
    </div>
  );
};
