...
export const CATEGORIES: Category[] = [
  {
    ...
    subcategories: [
      ...
      { id: 'sun-protection', labelEn: 'Sun Protection', labelAr: 'الحماية من الشمس' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'brushes-tools', labelEn: 'Brushes & Tools', labelAr: 'الفرش والأدوات' },
    ]
  },
  {
    id: 'hair-care',
...
export const SKIN_CONCERNS: SkinConcern[] = [
  { id: 'acne', labelEn: 'Acne & Blemishes', labelAr: 'حب الشباب', color: 'bg-red-100 text-red-700' },
  { id: 'anti-aging', labelEn: 'Anti-Aging', labelAr: 'مكافحة الشيخوخة', color: 'bg-purple-100 text-purple-700' },
  { id: 'hydration', labelEn: 'Hydration', labelAr: 'الترطيب', color: 'bg-blue-100 text-blue-700' },
  { id: 'oily-skin', labelEn: 'Oily Skin', labelAr: 'البشرة الدهنية', color: 'bg-yellow-100 text-yellow-700' },
  { id: 'dry-skin', labelEn: 'Dry Skin', labelAr: 'البشرة الجافة', color: 'bg-orange-100 text-orange-700' },
  { id: 'sensitivity', labelEn: 'Sensitivity', labelAr: 'الحساسية', color: 'bg-pink-100 text-pink-700' },
  { id: 'dark-spots', labelEn: 'Dark Spots', labelAr: 'البقع الداكنة', color: 'bg-amber-100 text-amber-700' },
  { id: 'wrinkles', labelEn: 'Wrinkles', labelAr: 'التجاعيد', color: 'bg-indigo-100 text-indigo-700' },
  { id: 'sun-protection', labelEn: 'Sun Protection', labelAr: 'الحماية من الشمس', color: 'bg-sky-100 text-sky-700' },
  { id: 'redness', labelEn: 'Redness', labelAr: 'الاحمرار', color: 'bg-rose-100 text-rose-700' },
  { id: 'cleansing', labelEn: 'Cleansing', labelAr: 'التنظيف', color: 'bg-teal-100 text-teal-700' },
];
...
export const PRICE_RANGES = [
  { id: 'under-10', min: 0, max: 10, labelEn: 'Under 10 JD', labelAr: 'أقل من 10 دينار' },
  { id: '10-25', min: 10, max: 25, labelEn: '10 - 25 JD', labelAr: '10 - 25 دينار' },
  { id: '25-50', min: 25, max: 50, labelEn: '25 - 50 JD', labelAr: '25 - 50 دينار' },
  { id: '50-100', min: 50, max: 100, labelEn: '50 - 100 JD', labelAr: '50 - 100 دينار' },
  { id: 'over-100', min: 100, max: 999999, labelEn: 'Over 100 JD', labelAr: 'أكثر من 100 دينار' },
];
...
export const getSubcategoryLabel = (categoryId: string, subcategoryId: string, language: 'en' | 'ar'): string => {
  const category = getCategoryById(categoryId);
  const subcategory = category?.subcategories.find(sub => sub.id === subcategoryId);
  return language === 'ar' ? subcategory?.labelAr || '' : subcategory?.labelEn || '';
};
