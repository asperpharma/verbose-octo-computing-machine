...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt =
      `You are "Asper Digital Concierge" - a warm, knowledgeable beauty pharmacist for Asper Beauty Shop in Jordan. You combine clinical skincare expertise with luxury service.
